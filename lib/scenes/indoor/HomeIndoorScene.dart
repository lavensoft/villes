...
class HomeIndoorScene extends StatefulWidget {
  const HomeIndoorScene({super.key});

  @override
  State<HomeIndoorScene> createState() => _HomeIndoorSceneState();
}

class _HomeIndoorSceneState extends State<HomeIndoorScene> {
